...
const AddItem = () => {
  ...
  const categories = [
    "Elektronik", "Perabot Kantor", "Kendaraan", "Alat Tulis Kantor (ATK)", 
    "Mesin & Alat Berat", "Fasilitas Umum", "Alat Kebersihan", "Keamanan (K3)"
  ];
            ...
            <Col md={6}>
              <Form.Group>
                ...
                <div className="d-flex gap-2">
                  <Form.Control type="text" value={formData.kode_barang} readOnly />
                  <Button variant="dark" onClick={handleGenerate}><QrCode size={18} /></Button>
                </div>
              </Form.Group>
            </Col>
          </Row>

          <Button type="submit" variant="primary" className="w-100 py-2 fw-bold d-flex align-items-center justify-content-center gap-2">
